...
const modelsInfo = {
    Company: ["id", "name", "businessName", "nit", "identification", "nEmployees", "logo", "state"],
...
const outputsInfo = {
    ...
    CompanyGroupBy: ["id", "name", "businessName", "nit", "identification", "nEmployees", "logo", "state", "_count", "_avg", "_sum", "_min", "_max"],
    ...
    CompanyCountAggregate: ["id", "name", "businessName", "nit", "identification", "nEmployees", "logo", "state", "_all"],
    CompanyAvgAggregate: ["nEmployees"],
    CompanySumAggregate: ["nEmployees"],
    CompanyMinAggregate: ["id", "name", "businessName", "nit", "identification", "nEmployees", "logo", "state"],
    CompanyMaxAggregate: ["id", "name", "businessName", "nit", "identification", "nEmployees", "logo", "state"],
...
const inputsInfo = {
    CompanyWhereInput: ["AND", "OR", "NOT", "id", "name", "businessName", "nit", "identification", "nEmployees", "logo", "state", "multimedia"],
    CompanyOrderByWithRelationInput: ["id", "name", "businessName", "nit", "identification", "nEmployees", "logo", "state", "multimedia"],
    CompanyWhereUniqueInput: ["id", "nit"],
    CompanyOrderByWithAggregationInput: ["id", "name", "businessName", "nit", "identification", "nEmployees", "logo", "state", "_count", "_avg", "_max", "_min", "_sum"],
    CompanyScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "name", "businessName", "nit", "identification", "nEmployees", "logo", "state"],
    ...
    CompanyCreateInput: ["id", "name", "businessName", "nit", "identification", "nEmployees", "logo", "state", "multimedia"],
    CompanyUpdateInput: ["id", "name", "businessName", "nit", "identification", "nEmployees", "logo", "state", "multimedia"],
    CompanyCreateManyInput: ["id", "name", "businessName", "nit", "identification", "nEmployees", "logo", "state"],
    CompanyUpdateManyMutationInput: ["id", "name", "businessName", "nit", "identification", "nEmployees", "logo", "state"],
    ...
    CompanyCountOrderByAggregateInput: ["id", "name", "businessName", "nit", "identification", "nEmployees", "logo", "state"],
    CompanyAvgOrderByAggregateInput: ["nEmployees"],
    CompanyMaxOrderByAggregateInput: ["id", "name", "businessName", "nit", "identification", "nEmployees", "logo", "state"],
    CompanyMinOrderByAggregateInput: ["id", "name", "businessName", "nit", "identification", "nEmployees", "logo", "state"],
    ...
    CompanyCreateWithoutMultimediaInput: ["id", "name", "businessName", "nit", "identification", "nEmployees", "logo", "state"],
    CompanyCreateOrConnectWithoutMultimediaInput: ["where", "create"],
    CompanyUpsertWithoutMultimediaInput: ["update", "create"],
    CompanyUpdateWithoutMultimediaInput: ["id", "name", "businessName", "nit", "identification", "nEmployees", "logo", "state"],
